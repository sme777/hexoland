...
export class Hex {
  ...
  initializeBondInstancedMeshes() {
    const bondCount = this.calculateBondCounts();
    const geometries = this.createBondGeometries();

    return {
      repulsiveXYBond: new THREE.InstancedMesh(
        geometries.repulsiveBond, 
        materials.repulsiveXYBond, 
        bondCount.repulsiveXYBond
      ),
      neutralXYBond: new THREE.InstancedMesh(
        geometries.neutralBond, 
        materials.neutralXYBond, 
        bondCount.neutralXYBond
      ),

      plugXYBond: new THREE.InstancedMesh(
        geometries.plugBond, 
        materials.attractiveXYBond, 
        bondCount.attractiveXYPlugBond
      ),

      socketXYBond: new THREE.InstancedMesh(
        geometries.socketBond, 
        materials.attractiveXYBond, 
        bondCount.attractiveXYSocketBond
      ),

      repulsiveZBond: new THREE.InstancedMesh(
        geometries.repulsiveBond, 
        materials.repulsiveZBond, 
        bondCount.repulsiveZBond
      ),
      neutralZBond: new THREE.InstancedMesh(
        geometries.neutralBond, 
        materials.neutralZBond, 
        bondCount.neutralZBond
      ),

      plugZBond: new THREE.InstancedMesh(
        geometries.plugBond, 
        materials.attractiveZBond, 
        bondCount.attractiveZPlugBond
      ),

      socketZBond: new THREE.InstancedMesh(
        geometries.socketBond, 
        materials.attractiveZBond, 
        bondCount.attractiveZSocketBond
      )
    };
